...
fn choose_filename(test: bool, filename: Option<String>) -> Result<String, Box<dyn std::error::Error>> {
...
fn dispatch(year: &str, day: &str, part: &str, contents: &str) -> Result<String, Box<dyn std::error::Error>> {
    return match year {
        "2023" => match day {
            "1" => match part {
